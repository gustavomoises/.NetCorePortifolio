...
namespace TableReady.Core.App
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<TableReadyContext>(options =>
                options.UseSqlServer(Configuration.GetConnectionString("TableReadyConnection")));
